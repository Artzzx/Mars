/**
 * Auto-generated Module: Frostbite Sorcerer
 * Base Class: Mage
 *
 * This module adds Frostbite-specific filter rules.
 */

import type { Rule } from '../../lib/filters/types';

export const frostbite_sorcererModule = {
  id: 'frostbite-sorcerer',
  name: 'Frostbite (Sorcerer)',
  category: 'Build',
  description: 'Optimized rules for Frostbite Sorcerer build. Hides items for other classes and highlights valuable Mage gear.',
  rules: [
    // Hide items not usable by Mage
    {
      ...
      isEnabled: true,
      emphasized: false,
      nameOverride: '[Frostbite] Other Class Items',
      soundId: 0,
      beamId: 0,
      order: 0,
    },
