import { Palette, Puzzle, Wand2 } from 'lucide-react';
  ...
  return (
    <>
      <div className="flex gap-3">
        ...
        <button className="flex-1 card p-4 hover:border-le-accent/50 transition-colors group bg-le-purple/10 border-le-purple/30">
          <div className="flex flex-col items-center justify-center gap-1">
            <div className="flex items-center gap-2">
              <Wand2 size={20} className="text-le-purple" />
              <span className="font-medium">AUTO-ADJUST FOR BUILD</span>
            </div>
            <span className="text-xs text-le-gold">(NEW!)</span>
          </div>
        </button>
      </div>
